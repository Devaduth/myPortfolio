...
const projects: Project[] = [
  {
    ...
    imageUrl: '/projects/soumyashyam.png',
  ...
  },
  {
    ...
    technologies: ['HTML5', 'SCSS', 'JavaScript','Bootstrap5' , 'Tailwind CSS'],
    imageUrl: '/projects/nutriboxx.png',
    projectUrl: 'https://www.nutriboxx.co.in/',
    githubUrl: 'https://www.nutriboxx.co.in/',
  },
  {
    title: 'IBS Consultants',
    description: 'Built a modern, responsive website for IBS Consultants, a leading Electro-Mechanical (MEP) systems consultancy specializing in sustainable and high-performance building solutions. Developed using React.js and Tailwind CSS, the site showcases their engineering expertise, services, and project portfolio with a clean and intuitive layout. Emphasized speed, scalability, and mobile-first design to ensure optimal user experience across all devices.',
    technologies: ['React', 'Redux', 'Node.js', 'Express', 'MongoDB'],
    imageUrl: '/projects/ibs.png',
    projectUrl: 'https://www.ibsconsultants.in/',
    githubUrl: 'https://www.ibsconsultants.in/',
  },
];
